...
# This information is not required, however if you have
# registered a bot with Wikipedia, I highly recommend you 
# use it. It will allow more results per query and will
# speed up the runtime when fetching page information
